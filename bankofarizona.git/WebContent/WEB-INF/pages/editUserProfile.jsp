...
<%@include file="/WEB-INF/pages/header2.jsp" %>
	<h2>${message}</h2>
	<form id="view-edituser-profile-form" method="GET"
		...
		<label><input type="submit"
		   ...
		   name="editUserProfile"
			id="editUserProfile" value="Edit User Profiles" path="editUserProfile" onclick="return validateeditUserProfile();"></label><br />
		<br />
	</form>
