...
<div id="main-content">
	...
	<form id="forgot-password-form" method="POST"
		...
		<label>Enter your user name</label> <input type="text" name="username" id="username" path="username" class="keyboardInput"><br /> <br>
		<br>
		<label><input type="submit"
			class="btn btn-lg btn-primary btn-block"
			onclick="return validateForgotPasswordForm();" name="submit"
